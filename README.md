...
| **Workspace** | `ws ls/datasets/reports/lineage/report-inventory/permissions/gateways/connections/datasources` (REST). `report-inventory` classifies reports **thin/thick + downloadable** (which are safe to export before a model edit) |
